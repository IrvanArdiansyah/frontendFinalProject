                    ...
                    <div className="container">
                        <div className="row pt-3">
                            <div className="col-lg-4 cardArChoice">
                                <img src="../aset/img/home/features/features_1.jpg" alt="features1" />
                            ...
                            <div className="col-lg-4 cardArChoice">
                                <img src="../aset/img/home/features/features_2.jpg" alt="features2" />
                                <div className="choiceInfo">
                                    <h3>Arsenic Choice</h3>
                            ...
                            <div className="col-lg-4 cardArChoice">
                                <img src="../aset/img/home/features/features_3.jpg" alt="features3" />
                                <div className="choiceInfo">
                                    <h3>Arsenic Choice</h3>
                            ...
                            <div className="col-lg-4 cardArChoice">
                                <img src="../aset/img/home/features/features_4.jpg" alt="features1" />
                                <div className="choiceInfo">
                                    <h3>Arsenic Choice</h3>
                            ...
                            <div className="col-lg-4 cardArChoice">
                                <img src="../aset/img/home/features/features_5.jpg" alt="features2" />
                                <div className="choiceInfo">
                                    <h3>Arsenic Choice</h3>
                                    <p>Wallet by Voyej</p>
                                    <button className="btn btn-outline-warning">Check it out!</button>
                            ...
                            <div className="col-lg-4 cardArChoice">
                                <img src="../aset/img/home/features/features_6.jpg" alt="features3" />
                                <div className="choiceInfo">
                                    <h3>Arsenic Choice</h3>
